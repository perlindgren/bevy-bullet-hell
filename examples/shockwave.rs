...
//! All code comes from the corresponding `shader/post_processing.rs` example from
//! the Bevy repo, with minimal changes.
//!
...
fn setup(
    ...
    for x in 0..40 {
        for y in 0..40 {
            let color = Color::linear_rgba(0.3, 0.6, 0.9, 1.0);
            commands.spawn(MaterialMesh2dBundle {
                ...
                transform: Transform::from_xyz(
                    20.0 * x as f32 - 300.0,
                    20.0 * y as f32 - 300.0,
                    1.0, // different z to avoid flicker
                ),
                ..default()
            });
        }
